...
//int TicTacToe5x5_Board::MM(int& x, int& y, bool ismax, bool frstime) {
//    int ans = check_s();
//    if (ans != 1)
//        return ans;
//    int lasti, lastj;
...
//                    if (frstime) {
//                        cout << row << "," << column
//                             << (result == 2 ? "x is winner" : (result = -2) ? "o is winner" : "draw");
//                    }
//                } else {
//                    board[row][column] = 'O';
//                    int result = MM(x, y, true, false);
//                    board[row][column] = 0;
//                    if (result <= minimum) {
//                        minimum = result;
//                        lasti = row;
...
int TicTacToe5x5_Board::MM(int &x, int &y, bool, bool) {
    return 0;
}
